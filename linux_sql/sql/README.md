# Introduction
Utilizing DDL, DML, DQL a database is populated, managed and queried to practice
...
#### Check if the psql container is already running
    docker ps -a
...
#### switch to the database exercises
    \c exercises
...
###### Question: ADD A LINE WITHOUT SPECIFYING AUTOINCREMENT ID VALUE
        ALTER TABLE facilities ALTER COLUMN facid SET DEFAULT nextval('facilities_facid_seq');

### UPDATE TABLE
###### Question: Update facilities table set initialouytlay = 10000 for the facid 1.
        UPDATE facilities SET initialoutlay = 10000 WHERE facid='1' ;

### Question: SUB-QUERY UPDATE
