...
public class LambdaStreamExc {
    ...
    Stream<String> createStrStream(String... Stings) {
        return null;
    }
     ...
     * e.g. filter (stringStream, "a") will return another stream which no element cotnains a
     *
     * @param stringStream
     * @param pattern
     * @return
    ...
    Stream<Integer> flatNestedInt(Stream<List<Integer>> int);
